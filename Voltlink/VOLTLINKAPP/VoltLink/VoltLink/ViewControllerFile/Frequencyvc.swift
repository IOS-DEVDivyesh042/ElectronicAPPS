...
class Frequencyvc : UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        resultLinearFrequencyLabel.layer.cornerRadius = 10
        resultLinearFrequencyLabel.layer.borderColor = UIColor.orange.cgColor
        resultLinearFrequencyLabel.layer.borderWidth = 3
        
        resultAngularFrequencyLabel.layer.cornerRadius = 10
        resultAngularFrequencyLabel.layer.borderColor = UIColor.orange.cgColor
        resultAngularFrequencyLabel.layer.borderWidth = 3
    }
